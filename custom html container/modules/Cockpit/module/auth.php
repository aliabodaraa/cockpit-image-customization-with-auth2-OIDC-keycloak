...
$this->module('cockpit')->extend([
    ...
    'authenticateViaOIDC' => function($data) use($app) {//added
        $data = array_merge([
            'user'     => '',
            'email'    => '',
            'group'    => '',
...
//        $app('session')->delete('cockpit.app.auth');
	$app('session')->destroy(); //added
	//logout user session from SSO Keycloak
	include_once($_SERVER['DOCUMENT_ROOT'] . '/OIDC_Keycloak_Cockpit/operations/logoutSSO.php');
	logoutKeycloak();
     },
