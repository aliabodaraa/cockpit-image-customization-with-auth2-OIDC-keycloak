...
class AuthController extends \LimeExtra\Controller {
   ...
   public function __construct($app) {
      ...
      $mapper=$_SESSION['u_name']??$_SESSION['u_email'];s
	  ...
	  $_GET['is_new_account'] = $user['is_new_account'];var_dsump("ASAS");
//          include_once($_SERVER['DOCUMENT_ROOT'] . '/OIDC_Keycloak_Cockpit/pages/success_authentication.php');
$this->reroute($this['cockpit.start']);return $this->invoke('Cockpit\\Controller\\Base', 'dashboard');
      }
