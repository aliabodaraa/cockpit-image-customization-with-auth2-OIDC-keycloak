...
class RestApi extends \LimeExtra\Controller {
	...
	//customize the output of the entries in collection___S___
	$_entries=[];
	foreach($entries as $_entry)
	    $_entries[]=array_filter($_entry, fn($_en) => isset($_en) && $_en !=="");
	$entries=$_entries;
	//customize the output of the entries in collection___E___
